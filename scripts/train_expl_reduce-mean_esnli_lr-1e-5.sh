#!/bin/bash
#SBATCH -J train_expl_reduce-mean_esnli_lr-1e-5
#SBATCH -o out/train_expl_reduce-mean_esnli_lr-1e-5.o%j
#SBATCH -e out/train_expl_reduce-mean_esnli_lr-1e-5.e%j
#SBATCH -p gtx

#!/bin/bash
#SBATCH -J train_xsum-expl_anli_lr-1e-5_alpha-0.5
#SBATCH -o out/train_xsum-expl_anli_lr-1e-5_alpha-0.5.o%j
#SBATCH -e out/train_xsum-expl_anli_lr-1e-5_alpha-0.5.e%j
#SBATCH -p gtx

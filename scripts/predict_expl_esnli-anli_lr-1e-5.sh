#!/bin/bash
#SBATCH -J predict-dev_bart-expl_esnli-anli_lr-1e-5
#SBATCH -o out/predict-dev_bart-expl_esnli-anli_lr-1e-5.o%j
#SBATCH -e out/predict-dev_bart-expl_esnli-anli_lr-1e-5.e%j
#SBATCH -p gtx
